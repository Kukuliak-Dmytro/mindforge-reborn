...
export const BestEmployeeCard: FC<IBestEmployeeCardProps> = ({
  ...
  return (
    <div
      className={cn(
        `bg-background p-4 sm:p-6 flex flex-col items-center gap-3 sm:gap-4
        text-center shadow-medium rounded-small w-full`,
      )}>
      <div
      ...
      <div className={cn("flex flex-col items-center gap-2")}>
        ...
        <p className={cn("p2 text-sm sm:text-base")}>
          На сайті з {workingSince}
        </p>
