...
export const BenefitCard: FC<IBenefitCardProps> = ({
  ...
  return (
    <div
      className={cn(
        `h-[400px] w-[240px] sm:h-[500px] sm:w-[280px] md:h-[600px] md:w-[300px]
        lg:h-[700px] lg:w-[316px]`,
        "border-t-4 sm:border-t-6 md:border-t-8 border-secondary-text",
        `rounded-b-[240px] sm:rounded-b-[280px] md:rounded-b-[300px]
        lg:rounded-b-[316px]`,
      ...
      <h2
        className={cn(
          `pt-3 sm:pt-4 md:pt-5 lg:pt-6 px-3 sm:px-4 text-base sm:text-lg
      ...
      <div className={cn("w-full h-auto")}>
        <Image
          ...
          height={316}
          className={cn(
            `w-full h-[240px] sm:h-[280px] md:h-[300px] lg:h-[316px]
            object-cover`,
          )}
        />
      </div>
